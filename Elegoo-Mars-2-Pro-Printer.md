...
You will need to obtain or export an STL (or .OBJ, .3MF) model of the part you wish to print. A slicer software can turn the model into a series of instructions for the printer to use. For the Mars 2 printer, the sliced file needs to be a .CTB file. To produce one of these, use either the [official software ChituBox](https://www.chitubox.com/en/article/support/howto/chitubox-free/installation/50) or the [Lychee Slicer](https://mango3d.io/downloads/). Both of these require an online account.
...
* [Swindon Makerspace Blog and video of this printer](https://www.swindon-makerspace.org/2022/03/05/elegoo-mars-2-pro-resin-printer/)
